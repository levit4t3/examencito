...
public class servidor extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        String msj = "";  
        int prim;
            prim = Integer.parseInt(JOptionPane.showInputDialog("Escribe el tamaño del primo: 10, 100, 1000"));
            RSA cod = new RSA(prim);
            cod.generarPrimos();
            cod.generarClaves();
        try {  
            ...
            while (!msj.equals("salir")) {  
                msj = dtinpt.readUTF();  
                BigInteger[] s = cod.encriptar(msj);
                txtbxarea.setText(txtbxarea.getText().trim() + "\n Cliente: \nMensaje Cifrado: " + s +"\np:"+ cod.p + "\nMensaje Descifrado: " + cod.desencriptar(s));  
